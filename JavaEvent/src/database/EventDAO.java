...
public class EventDAO extends DAO<Event>{
    ...
    private HashSet<User> getParticipants(long id) throws SQLException{
        ...
        PreparedStatement preparedStatement = null;
        ResultSet result = null;
        final String query = "SELECT creator_id, email, password, firstName, lastName, departement FROM Users, Events, Participants WHERE Participants.event = ? AND User.creator_id = Participants.user";
        try {
            preparedStatement = initializePreparedStatement(query, false, id);
            result = preparedStatement.executeQuery();
            while(result.next()){
